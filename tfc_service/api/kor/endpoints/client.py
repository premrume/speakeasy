...
from api.kor.logic.tf_client import make_prediction
from werkzeug.datastructures import FileStorage
from nltk import sent_tokenize

# create dedicated namespace for ENDE client
ns = api.namespace('kor_client', description='Operations for Translating the kor  model')
